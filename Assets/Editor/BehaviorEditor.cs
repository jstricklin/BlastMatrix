    ...
    public class BehaviorEditor : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            if (forceSetDirty)           
            {
                ...
                // Debug.Log("saving... forceSetDirtyTrue");
            }
        }
        ...
        void UserInput(Event e)
        {
            ...
            if (e.button == 0 && !settings.makeTransition || e.button == 2)
            {
                ...
                // scroll below
                if (e.button == 0 && trackpadScroll && !clickedOnWindow || e.button == 2)
                {
                    if (e.type == EventType.MouseDown)
                    {
                        // LeftClick(e);
        ...
        void AddNewNode(Event e)
        {
            ...
            if (settings.currentGraph != null)
            {
                ...
                if (trackpadScroll)
                {
                    menu.AddItem(new GUIContent("Disable Trackpad Scroll"), false, ContextCallback, UserActions.toggleTrackpadScroll);
                } 
                else
                {
                    menu.AddItem(new GUIContent("Enable Trackpad Scroll"), false, ContextCallback, UserActions.toggleTrackpadScroll);
                }
        ...
        void ModifyNode(Event e)
        {
            ...
            if (selectedNode.drawNode is StateNode)
            {
                ...
                if (stateNode != null && selectedNode.isAssigned)
                    {
                        menu.AddSeparator("");
        ...
        void ContextCallback(object o)
        {
            ...
            switch(a)
            {
                ...
                case UserActions.resetPanning :
                    ResetPanning();
                    break;
                case UserActions.toggleTrackpadScroll : 
        ...
        {
            // Debug.Log($"add transition node {enterNode.id}");
